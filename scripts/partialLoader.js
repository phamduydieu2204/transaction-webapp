...
export async function initializePartials() {
  // PartialLoader: Starting optimized partial loading...
  ...
  try {
    ...
    const allPartials = [
      ...
      { elementId: 'source-tab-container', partialPath: './partials/tabs/source-tab.html', priority: 2 },
    ...
    Promise.all(preloadPromises).then(() => {
      // All partials preloaded successfully
    });
    ...
    // All partials loading initiated
